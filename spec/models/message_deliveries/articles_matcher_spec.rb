...
RSpec.describe MessageDeliveries::ArticlesMatcher, :type => :model do
  context "with child born, male and five months old" do
    context "and articles that applicable for that child" do
      subject { MessageDeliveries::ArticlesMatcher.new(Articles::JournalisticArticle.all, @child, @system_date).find_articles_for_child }
