...
# and theere is a difference of three hours between, Sao Paulo
# and N. Virginia, so we setup whenever to run at 2 pm N. Virgina
# the tasks will be run at 11 am in Sao Paulo
every [:monday, :wednesday, :friday],  at: '2pm' do
