...
class SampleData
  ...
  def seed
    ActiveRecord::Base.transaction do
      ...
      create(:user, :publisher, email: 'publisher@probebe.com.br')
      ...
      create(:article, maximum_valid_week: 12, baby_target_type: 'pregnancy', messages:
              create_list(:message, 1, text: "Mensagem para bebê em gestação sexo masculino ate 3 meses"))
      create(:article, maximum_valid_week: 16, baby_target_type: 'born', gender: 'both', messages:
              create_list(:message, 1, text: "Mensagem para bebê nascido de ambos sexo, em gestação de ate 5 meses"))
      create(:article, minimum_valid_week: 8, baby_target_type: 'born', gender: 'female', messages:
              create_list(:message, 1, text: "Mensagem para bebê nascido de sexo feminino, em gestação minima de 2 meses"))
      create(:article, maximum_valid_week: 40, baby_target_type: 'pregnancy', messages:
