...
User.create!(email: 'journalist@probebe.com.br', role: 'journalist', password: 'v1z12010', profile: (Profile.create!(name: 'Journalist'))) unless User.find_by(email: 'journalist@probebe.com.br')
